...
import { SafeAreaView, StyleSheet, TouchableOpacity, Text, View, TextInput, Pressable, Animated } from "react-native";
...
const ItemListView: React.FC<ItemListViewProps> = ({item}) => {
